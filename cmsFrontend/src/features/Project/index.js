...
import { SoftDeleteProjectService } from '../../services/projectService';
...
function Project() {
    ...
    let { dataProject, isLoading } = useSelector((state) => state.ProjectReducer);
